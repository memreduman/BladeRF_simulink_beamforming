...
Rx_Antennas = phased.ULA('NumElements',2,'ElementSpacing',0.05,'ArrayAxis','y');
Elem = phased.IsotropicAntennaElement('FrequencyRange',[700,2600e6]);
%Elem = phased.CrossedDipoleAntennaElement('FrequencyRange',[700,2600e6]);
Rx_Antennas.Element = Elem;

% Tx Antennas
%Subarray antennas
Tx_Antennas = phased.ULA('NumElements',2,'ElementSpacing',0.05,'ArrayAxis','y');
