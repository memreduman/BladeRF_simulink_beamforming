...
sdrqpsktx.MessageLength   = strlength(sdrqpsktx.Message) + 5;              % 'Hello world 000\n'...
sdrqpsktx.NumberOfMessage = 100;                                           % Number of messages in a frame
...
%% Message generation
msgSet = zeros(100 * sdrqpsktx.MessageLength, 1); 
for msgCnt = 0 : 99
