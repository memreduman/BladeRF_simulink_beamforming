...
sdrqpsktx.Rsym = 0.3e6;             % Symbol rate in Hertz
...
sdrqpsktx.BladeRF.stream.n_buffers = 256*2;
sdrqpsktx.BladeRF.stream.n_transfers = 8*2;
sdrqpsktx.BladeRF.stream.buffer_size = 1024*20*2; %16384
sdrqpsktx.BladeRF.stream.timeout = 5000;
