...
% Rx Antennas
Rx_Antennas = phased.ULA('NumElements',2,'ElementSpacing',0.1,'ArrayAxis','y','Taper',1);
Elem = phased.IsotropicAntennaElement;
Elem.FrequencyRange = [0 fc];
Rx_Antennas.Element = Elem;

% Tx Antennas
Tx_Antennas = phased.ULA('NumElements',2,'ElementSpacing',0.1,'ArrayAxis','y','Taper',1);
