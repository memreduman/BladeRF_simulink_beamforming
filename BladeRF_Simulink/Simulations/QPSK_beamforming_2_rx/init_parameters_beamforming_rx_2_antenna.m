...
% Antennas
Antennas = phased.ULA('NumElements',2,'ElementSpacing',0.05,'ArrayAxis','y','Taper',1);
Elem = phased.IsotropicAntennaElement;
Elem.FrequencyRange = [0 fc];
Antennas.Element = Elem;
...
qpsktxrx.Rsym = 0.3e3;               % Symbol rate in Hertz
...
qpsktxrx.MessageLength   = strlength(qpsktxrx.Message) + 1;                % 'Hello world 000\n'...
